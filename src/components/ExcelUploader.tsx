    ...
    return (
        <>
            <button
                ...
                className="flex items-center space-x-2 bg-white hover:bg-emerald-50 text-emerald-700 px-4 py-2 rounded-xl font-bold shadow-sm border border-emerald-100 transition-all duration-300 active:scale-95"
                title="엑셀 일괄 업로드"
            >
                ...
                <span className="text-sm">엑셀 파일 연동</span>
            </button>
